...
export const AdminNetworkPage = () => {
  const { resourceExchange } = useData();
  ...
  return (
    <div className="space-y-6 pb-16">
      ...
      <div className="ncct-page-header space-y-4">
        <div>
          <div className="flex items-center gap-2">
            <h1 className="text-xl font-semibold text-slate-900">NCCT Network Command Centre & Resource Exchange</h1>
      ...
      <div className="ncct-chrome text-white p-6 rounded-2xl shadow-md space-y-4">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-indigo-800 pb-3">
          <div>
            ...
            <h2 className="text-base font-semibold text-white">National Seat Capacity & Demand Balance</h2>
          </div>
          <button
            onClick={() => alert('Reviewing network seat reallocation recommendations...')}
            className="px-4 py-2 rounded-full bg-indigo-600 text-white text-xs font-semibold hover:bg-indigo-700 transition-colors"
          >
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 text-center">
          <div className="p-3 bg-white/10 rounded-xl border border-white/15">
            ...
            <span className="text-xl font-semibold text-white">2,840 Seats</span>
          </div>
          <div className="p-3 bg-white/10 rounded-xl border border-white/15">
            <span className="text-[10px] text-indigo-300 uppercase block">Available Network Capacity</span>
            <span className="text-xl font-semibold text-teal-300">3,420 Seats</span>
          </div>
          <div className="p-3 bg-white/10 rounded-xl border border-white/15">
            <span className="text-[10px] text-indigo-300 uppercase block">Network Utilisation</span>
            <span className="text-xl font-semibold text-amber-300">83%</span>
          </div>
          <div className="p-3 bg-white/10 rounded-xl border border-white/15">
            <span className="text-[10px] text-indigo-300 uppercase block">Unmet Regional Demand</span>
            <span className="text-xl font-semibold text-red-400">318 Seats</span>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-2xs space-y-4">
        <div className="flex items-center justify-between border-b border-slate-100 pb-3">
          <div>
            <h2 className="text-lg font-semibold text-slate-900">NCCT Resource Exchange</h2>
          ...
          <button
            ...
            className="px-3.5 py-2 rounded-full bg-indigo-600 text-white font-semibold text-xs hover:bg-indigo-700 transition-colors flex items-center gap-1.5"
          >
          ...
          {resourceExchange.map(res => (
            <div key={res.id} className="p-4 rounded-xl border border-slate-200 bg-slate-50/50 space-y-2 flex flex-col justify-between">
              <div>
                ...
                <h3 className="text-base font-semibold text-slate-900 mt-1">{res.resourceName}</h3>
              ...
              <div className="pt-2">
                <button
                  onClick={() => openModal('resource_request')}
                  className="w-full py-1.5 rounded-full bg-white border border-slate-300 hover:bg-indigo-50 hover:border-indigo-300 text-indigo-700 font-bold text-xs transition-colors"
                >
