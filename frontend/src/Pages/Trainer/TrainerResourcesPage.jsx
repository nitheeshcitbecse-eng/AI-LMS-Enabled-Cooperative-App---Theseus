    ...
    <div className="space-y-6 pb-12">
      ...
      <div className="ncct-page-header space-y-4">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            <h1 className="text-xl font-semibold text-slate-900">Teaching Resources & Remedial Library</h1>
          ...
          <button
            ...
            className="px-4 py-2.5 rounded-full bg-indigo-600 text-white font-semibold text-xs hover:bg-indigo-700 shadow-sm transition-colors flex items-center gap-2 w-max"
          >
          ...
          <div key={index} className="bg-white p-5 rounded-2xl border border-slate-200 shadow-2xs space-y-3 hover:border-indigo-300 transition-all flex flex-col justify-between">
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <span className="text-[10px] text-slate-400 tabular-nums">{item.size}</span>
              </div>
