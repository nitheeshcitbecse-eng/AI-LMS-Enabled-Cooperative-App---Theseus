...
import { Users, Calendar, Award, ChevronRight, CheckCircle2, AlertTriangle, ArrowUpRight } from 'lucide-react';
import { useApp } from '../../context/SystemStateContext';

export const TrainerBatchesPage = () => {
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 ncct-page-header">
        <div>
          <div className="flex items-center gap-2">
            <h1 className="text-xl font-semibold text-slate-900">My Batches & Training Cohorts</h1>
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="px-3.5 py-2 rounded-full bg-white border border-slate-300 hover:bg-indigo-50 hover:border-indigo-300 text-indigo-700 text-xs font-bold transition-colors"
          >
            Back to Overview
          </button>
        </div>
          ...
          <div key={batch.id} className="bg-white rounded-2xl border border-slate-200 p-6 shadow-2xs space-y-4 hover:border-indigo-300 transition-all">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-slate-100 pb-4">
              ...
              <div className="flex items-center gap-3">
                <button
                  ...
                  className="px-4 py-2 rounded-full bg-indigo-600 text-white text-xs font-semibold hover:bg-indigo-700 transition-colors flex items-center gap-1.5"
                >
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 pt-2">
              <div className="p-3 bg-slate-50 rounded-xl border border-slate-100">
                ...
                <span className="text-lg font-semibold text-slate-900 flex items-center gap-1.5">
              ...
              <div className="p-3 bg-slate-50 rounded-xl border border-slate-100">
                ...
                <div className="flex items-center gap-2 mt-1">
                  <div className="flex-1 bg-slate-200 h-2 rounded-full overflow-hidden">
                    <div className="bg-amber-500 h-full rounded-full" style={{ width: `${batch.progressPercent}%` }} />
                  </div>
              ...
              <div className="p-3 bg-slate-50 rounded-xl border border-slate-100">
                ...
                <span className="text-lg font-semibold text-emerald-700 flex items-center gap-1.5">
              ...
              <div className="p-3 bg-slate-50 rounded-xl border border-slate-100">
                ...
                <span className={`text-lg font-semibold flex items-center gap-1.5 ${batch.atRiskCount > 0 ? 'text-red-600' : 'text-slate-700'}`}>
