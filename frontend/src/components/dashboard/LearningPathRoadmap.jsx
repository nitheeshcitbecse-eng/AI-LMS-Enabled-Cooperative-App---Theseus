...
export const LearningPathRoadmap = () => {
  ...
  const [selectedNode, setSelectedNode] = useState(nodes[3]); // Default to Financial Analysis
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-1">
              {selectedNode.skillsGained.map(skill => (
                <span key={skill} className="px-2 py-0.5 rounded-full bg-white text-indigo-950 font-semibold border border-slate-200 text-[11px] flex items-center gap-1">
