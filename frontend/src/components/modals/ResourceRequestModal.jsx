...
export const ResourceRequestModal = () => {
  ...
  const handleSend = async () => {
    try {
      await adminService.requestResource({ source_institute: 'RICM Hyderabad' });
    } catch (err) {
      ...
      <div className="bg-white rounded-2xl max-w-md w-full ring-1 ring-slate-200 shadow-2xl animate-in zoom-in-95 duration-300 overflow-hidden space-y-4">
        <div className="p-4 bg-indigo-600 text-white flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-sm font-semibold">NCCT Resource Exchange Request</h3>
          </div>
        ...
        <div className="p-5 space-y-4 text-xs">
          <div className="bg-slate-50 p-3 rounded-xl border border-slate-200 space-y-1">
            ...
            <h4 className="font-semibold text-slate-900">Biometric Face Recognition Attendance Kiosks (6 units)</h4>
