  ...
  return (
    <div className="space-y-6 pb-12">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 ncct-page-header">
        <div>
          <h1 className="text-xl font-semibold text-slate-900">Career & Placement Ecosystem Preview</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 space-y-4">
          <h3 className="text-lg font-semibold text-slate-900">Recommended Cooperative Openings</h3>
          ...
          {opportunities.map(opp => (
            ...
            >
              <div className="flex items-start justify-between">
                ...
                <span className="px-3 py-1 rounded-xl bg-emerald-600 text-white font-bold text-xs shadow-2xs">
