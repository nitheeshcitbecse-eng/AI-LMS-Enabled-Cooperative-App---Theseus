...
export const AdminCapacityPage = () => {
  ...
  return (
    <div className="space-y-6 pb-16">
      ...
      <div className="ncct-page-header space-y-4">
        <div>
          <div className="flex items-center gap-2">
            <h1 className="text-xl font-semibold text-slate-900">Capacity & Resource Intelligence</h1>
      ...
      <div className="ncct-chrome text-white p-5 rounded-2xl shadow-md flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-xs font-semibold text-white">Smart Allocation Recommendation</h3>
        ...
        <button
          ...
          className="px-4 py-2 rounded-full bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-semibold transition-colors shrink-0 shadow-sm"
        >
          Optimise Schedule
        </button>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-2xs space-y-4">
          <div className="flex items-center justify-between border-b border-slate-100 pb-3">
            <h2 className="text-lg font-semibold text-slate-900">Classroom Utilisation Rate</h2>
            <span className="text-xs tabular-nums font-bold text-teal-700 bg-teal-50 px-2 py-0.5 rounded-full border border-teal-200">
              ICM Chennai
            </span>
          </div>
          ...
          <div className="h-64">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={roomData} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                ...
                <Tooltip />
                <Bar dataKey="utilisation" fill="#0ea5e9" radius={[6, 6, 0, 0]} />
              </BarChart>
            </ResponsiveContainer>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-2xs space-y-4">
          <div className="flex items-center justify-between border-b border-slate-100 pb-3">
            <h2 className="text-lg font-semibold text-slate-900">Trainer Faculty Load (%)</h2>
            <span className="text-xs tabular-nums font-bold text-indigo-800 bg-indigo-50 px-2 py-0.5 rounded-full border border-indigo-200">
              Weekly Allocation
            </span>
          </div>
          ...
          <div className="h-64">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={trainerData} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                ...
                <YAxis domain={[0, 100]} tickLine={false} tick={{ fontSize: 11, fill: '#64748b' }} />
                <Tooltip />
                <Bar dataKey="load" fill="#075985" radius={[6, 6, 0, 0]} />
              </BarChart>
            </ResponsiveContainer>
          </div>
        </div>
      ...
      <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-2xs space-y-4">
        <h2 className="text-lg font-semibold text-slate-900 border-b border-slate-100 pb-3">Equipment & Hardware Availability</h2>
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div className="p-4 rounded-xl bg-slate-50 border border-slate-200 space-y-1">
            <span className="text-xs font-bold text-slate-700 block">Interactive Projectors</span>
            <span className="text-xl font-semibold text-slate-900">12 / 14 Available</span>
          ...
          <div className="p-4 rounded-xl bg-slate-50 border border-slate-200 space-y-1">
            ...
            <span className="text-xl font-semibold text-slate-900">8 / 10 Available</span>
          ...
          <div className="p-4 rounded-xl bg-slate-50 border border-slate-200 space-y-1">
            ...
            <span className="text-xl font-semibold text-slate-900">18 / 20 Available</span>
