...
export const TrainerTraineesPage = () => {
    ...
    <div className="space-y-6 pb-12">
      ...
      <div className="ncct-page-header space-y-4">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            <h1 className="text-xl font-semibold text-slate-900">Trainees Roster & Individual Profiles</h1>
            <p className="text-xs text-slate-500 mt-1">
              Batch <span className="tabular-nums font-bold text-indigo-950">CMDO-2026-B04</span> — Interactive AI learning risk analytics and profile drawer.
            </p>
          </div>
          <button
            onClick={() => alert('Exporting full batch roster to CSV...')}
            className="px-3.5 py-2 rounded-full bg-white border border-slate-300 hover:bg-indigo-50 hover:border-indigo-300 text-indigo-700 text-xs font-bold transition-colors flex items-center gap-1.5 w-max"
          >
