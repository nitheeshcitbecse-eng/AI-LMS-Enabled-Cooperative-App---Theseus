...
export const CompetencyVerificationCard = () => {
      ...
      <div className="flex items-center justify-between border-b border-slate-100 pb-3">
        <div>
          <div className="flex items-center gap-2">
            <h3 className="text-lg font-semibold text-slate-900">Competency Verification Ledger</h3>
            <span className="px-2.5 py-0.5 rounded-full bg-emerald-50 text-emerald-800 text-[10px] font-semibold border border-emerald-200">
              Trainer Validation
            </span>
          </div>
          ...
          return (
            ...
            >
              <div className="space-y-1">
                <div className="flex items-center gap-2">
                  <h4 className="text-xs font-semibold text-slate-900">{claim.traineeName}</h4>
                  <span className="text-[10px] text-slate-400 tabular-nums">({claim.digitalId})</span>
              ...
              <div className="flex items-center gap-2 shrink-0">
                {isVerified ? (
                  <div className="px-4 py-2 rounded-xl bg-emerald-100 text-emerald-800 font-semibold text-xs flex items-center gap-1.5 border border-emerald-300">
                  ...
                  <button
                    ...
                    className="px-4 py-2 rounded-full bg-indigo-600 text-white font-semibold text-xs hover:bg-indigo-700 transition-colors flex items-center gap-1.5 shadow-sm"
                  >
