...
export const AdminTraineesPage = () => {
      ...
      <div className="ncct-page-header space-y-4">
        <div>
          <div className="flex items-center gap-2">
            <h1 className="text-xl font-semibold text-slate-900">Trainee Operations & Roster Monitoring</h1>
            ...
            <tbody className="divide-y divide-slate-100">
              {traineeRiskList.map(trainee => (
                ...
                >
                  ...
                  <td className="py-3 px-3 font-semibold text-slate-900">{trainee.assessmentScore}%</td>
