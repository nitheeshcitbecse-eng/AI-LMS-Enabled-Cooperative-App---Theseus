...
export const PrioritiesEngine = () => {
  ...
  return (
    <div className="ncct-card p-5 space-y-4 bg-gradient-to-br from-white via-white to-amber-50/20">
      {/* Header */}
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-slate-100 pb-3">
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-2">
              <h3 className="text-lg font-semibold text-slate-900">Today's Training Priorities Engine</h3>
              <span className="px-2 py-0.5 rounded-full bg-amber-100 text-amber-900 text-[10px] font-semibold border border-amber-300">
                AI Priority System
              </span>
            </div>
        ...
        <button
          ...
          className="px-4 py-2 rounded-full bg-indigo-600 hover:bg-indigo-700 text-white font-semibold text-xs flex items-center gap-1.5 transition-colors shadow-sm shrink-0"
        >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-1">
        ...
        <div className="p-4 rounded-xl bg-red-50/80 border border-red-200 space-y-3 shadow-2xs">
          <div className="flex items-center justify-between">
            <span className="px-2 py-0.5 rounded-full bg-red-50 ring-1 ring-red-200 text-red-700 text-[10px] font-semibold ">
              High Priority
            </span>
        ...
        <div className="p-4 rounded-xl bg-amber-50/80 border border-amber-200 space-y-3 shadow-2xs">
          <div className="flex items-center justify-between">
            <span className="px-2 py-0.5 rounded-full bg-amber-50 ring-1 ring-amber-200 text-amber-700 text-[10px] font-semibold ">
              Medium Priority
            </span>
          ...
          <div className="pt-2 border-t border-amber-200/60 flex items-center justify-between">
            ...
            <button
              ...
              className="px-3 py-1.5 rounded-full bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-semibold transition-colors shadow-2xs"
            >
              Send Reminder
            </button>
          </div>
        ...
        <div className="p-4 rounded-xl bg-emerald-50/80 border border-emerald-200 space-y-3 shadow-2xs">
          <div className="flex items-center justify-between">
            <span className="px-2 py-0.5 rounded-full bg-emerald-50 ring-1 ring-emerald-200 text-emerald-700 text-[10px] font-semibold ">
              Positive Signal
            </span>
