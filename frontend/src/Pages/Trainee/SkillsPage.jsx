          ...
          return (
            ...
            >
              ...
              {isAttention && (
                <button
                  onClick={() => openModal('booster_quiz')}
                  className="w-full py-2 rounded-full bg-indigo-600 hover:bg-indigo-700 text-white font-semibold text-xs transition-colors flex items-center justify-center gap-1.5 shadow-2xs"
                >
                  <Zap className="w-4 h-4 fill-white" />
