  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 ncct-page-header">
        <div>
          <h1 className="text-xl font-semibold text-slate-900">NCCT National ERP & Centralized Data Analytics</h1>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="ncct-card p-4 space-y-1">
          ...
          <span className="text-2xl font-semibold text-indigo-950 block">14,280</span>
        ...
        <div className="ncct-card p-4 space-y-1">
          ...
          <span className="text-2xl font-semibold text-teal-700 block">94.2%</span>
        ...
        <div className="ncct-card p-4 space-y-1">
          ...
          <span className="text-2xl font-semibold text-emerald-700 block">38,940</span>
        ...
        <div className="ncct-card p-4 space-y-1">
          ...
          <span className="text-2xl font-semibold text-amber-700 block">89.6%</span>
      ...
      <div className="ncct-card p-6 space-y-4">
        <div className="flex items-center justify-between border-b border-slate-100 pb-3">
          <div>
            <h3 className="text-lg font-semibold text-slate-900">Regional Outreach & PACS Computerization Readiness</h3>
        ...
        <div className="h-72 w-full pt-2">
          <ResponsiveContainer width="100%" height="100%">
            <BarChart data={nationalData} margin={{ top: 10, right: 10, left: -10, bottom: 0 }}>
              ...
              <Bar dataKey="trainees" fill="#0284c7" name="Active Trainees" radius={[4, 4, 0, 0]} />
              <Bar dataKey="erpAdoption" fill="#0ea5e9" name="PACS ERP Adoption %" radius={[4, 4, 0, 0]} />
