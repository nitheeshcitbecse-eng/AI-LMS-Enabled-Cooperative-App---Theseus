    ...
    <div className="space-y-6 pb-16">
      ...
      <div className="ncct-page-header space-y-4">
        <div>
          <div className="flex items-center gap-2">
            <h1 className="text-xl font-semibold text-slate-900">Certification Pipeline & Verification Repository</h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
        <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-2xs space-y-1">
          ...
          <div className="text-2xl font-semibold text-slate-900">1,032</div>
        </div>

        <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-2xs space-y-1">
          <span className="text-xs text-indigo-700 font-bold uppercase block">Eligibility Verified</span>
          <div className="text-2xl font-semibold text-indigo-950">980</div>
        </div>
        ...
        <div className="bg-white p-5 rounded-2xl border border-teal-200 shadow-2xs space-y-1">
          ...
          <div className="text-2xl font-semibold text-teal-900">947</div>
        </div>
        ...
        <div className="bg-white p-5 rounded-2xl border border-emerald-300 shadow-2xs space-y-1 bg-emerald-50/20">
          ...
          <div className="text-2xl font-semibold text-emerald-900">812</div>
        </div>
      </div>
    </div>
  );
