...
export const AILearningIntelligence = () => {
  ...
  return (
    <div className="ncct-card p-5 space-y-5 bg-gradient-to-br from-white via-white to-amber-50/20">
      {/* Header */}
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-2">
              <h3 className="text-lg font-semibold text-slate-900">AI Learning Intelligence</h3>
        ...
        <div className="p-3.5 rounded-xl bg-emerald-50/60 border border-emerald-200/60 space-y-1.5">
          ...
          <div className="flex flex-wrap gap-1.5 pt-1">
            {['Cooperative Principles', 'Communication', 'Digital Tools'].map(item => (
              <span key={item} className="px-2 py-0.5 rounded-full bg-white text-emerald-900 text-xs font-semibold border border-emerald-200 shadow-2xs">
                ✓ {item}
              </span>
            ))}
          </div>
        ...
        <div className="p-3.5 rounded-xl bg-amber-50/60 border border-amber-200/60 space-y-1.5">
          ...
          <div className="flex flex-wrap gap-1.5 pt-1">
            {['Cooperative Accounting', 'Financial Analysis'].map(item => (
              <span key={item} className="px-2 py-0.5 rounded-full bg-white text-amber-900 text-xs font-semibold border border-amber-200 shadow-2xs">
                ! {item}
              </span>
            ))}
          </div>
      ...
      <div className="p-4 rounded-xl bg-white border-2 border-amber-300/80 shadow-xs space-y-4">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          <div className="space-y-1">
            <div className="flex items-center gap-2">
              <span className="px-2 py-0.5 rounded-full bg-amber-50 ring-1 ring-amber-200 text-amber-700 text-[10px] font-bold ">
          ...
          <button
            ...
            className="px-5 py-2.5 rounded-full bg-indigo-600 text-white font-semibold text-xs hover:bg-indigo-700 transition-colors flex items-center justify-center gap-2 shadow-sm shrink-0"
          >
