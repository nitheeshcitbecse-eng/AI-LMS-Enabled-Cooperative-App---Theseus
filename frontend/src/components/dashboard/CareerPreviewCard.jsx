...
export const CareerPreviewCard = () => {
  const { careerOpportunities } = useData();
      ...
      <div className="flex items-center justify-between border-b border-slate-100 pb-3">
        <div>
          <div className="flex items-center gap-2">
            <h3 className="text-lg font-semibold text-slate-900">Opportunities Matching Your Skills</h3>
        ...
        {careerOpportunities.map(opp => (
          ...
          >
            <div className="flex items-start justify-between gap-3">
              ...
              {/* Match Badge */}
              <div className="px-2.5 py-1 rounded-lg bg-emerald-50 ring-1 ring-emerald-200 text-emerald-700 font-bold text-xs shadow-2xs shrink-0">
