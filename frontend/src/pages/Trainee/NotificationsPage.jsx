  ...
  return (
    <div className="space-y-6 pb-12">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 ncct-page-header">
        <div>
          <h1 className="text-xl font-semibold text-slate-900">Notifications & System Alerts</h1>
          ...
          >
            <div className="flex items-start gap-3">
              ...
              <div className="space-y-0.5">
                ...
                <span className="text-[10px] text-slate-400 tabular-nums block">{item.timestamp}</span>
              </div>
            </div>
          </div>
        ))}
