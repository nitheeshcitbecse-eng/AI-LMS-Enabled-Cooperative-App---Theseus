...
export const CertificateDetailModal = () => {
  ...
  const handleDownloadPDF = () => {
    alert(`Downloading Sample Certificate PDF for ${trainee.name} (${selectedCertificate.credentialId})...`);
  };

  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/70 backdrop-blur-md animate-in fade-in duration-200">
      <div className="bg-white rounded-3xl max-w-3xl w-full p-6 lg:p-8 shadow-2xl ring-1 ring-slate-200 animate-in zoom-in-95 duration-300 space-y-6 relative max-h-[92vh] overflow-y-auto">
        ...
        <div className="p-8 lg:p-12 rounded-2xl bg-gradient-to-b from-amber-50/50 via-white to-amber-50/30 border-8 border-double border-indigo-950/20 shadow-xl relative text-center space-y-6 select-none">
          ...
          <div className="space-y-1.5 pt-2">
            <div className="w-16 h-16 rounded-full bg-indigo-600 text-amber-400 font-serif font-black text-xl flex items-center justify-center mx-auto shadow-lg border-2 border-amber-400">
              NCCT
            </div>
          ...
          <div className="space-y-3">
            ...
            <div className="py-1">
              ...
              <p className="text-[11px] text-slate-500 font-mono mt-1">Roll No: {trainee.id} • Batch: {trainee.batch}</p>
            </div>
            ...
            <div className="p-4 rounded-xl bg-indigo-600 text-white max-w-xl mx-auto shadow-md border border-indigo-900">
              <h3 className="text-base font-bold text-amber-300 font-sans">
                {selectedCertificate.title}
              </h3>
              <p className="text-xs text-indigo-200 mt-1 font-sans">
                Evaluation Grade: <span className="font-bold text-emerald-400">Distinction (88.4%)</span> • Issued at <span className="font-semibold text-white">{trainee.institute}</span>
              </p>
            </div>
          </div>
          ...
          <div className="pt-6 border-t border-slate-300 grid grid-cols-3 items-end gap-4 text-left">
            ...
            <div className="text-center space-y-1">
              ...
              <p className="text-[9px] text-slate-400">{trainee.institute}</p>
            </div>
        ...
        <div className="flex flex-wrap items-center justify-between gap-3 pt-2">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="px-5 py-2.5 rounded-lg bg-indigo-600 text-white font-semibold text-xs hover:bg-indigo-700 transition-colors flex items-center gap-2 shadow-sm"
            >
