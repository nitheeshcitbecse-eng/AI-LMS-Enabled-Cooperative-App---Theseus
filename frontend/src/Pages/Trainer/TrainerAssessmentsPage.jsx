...
export const TrainerAssessmentsPage = () => {
    ...
    <div className="space-y-6 pb-12">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            <div className="flex items-center gap-2">
              <h1 className="text-xl font-semibold text-slate-900">Assessments & Topic Heatmap Matrix</h1>
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="px-3.5 py-2 rounded-full bg-indigo-600 text-white hover:bg-indigo-700 text-xs font-semibold transition-colors shadow-sm flex items-center gap-1.5"
            >
      ...
      <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-2xs space-y-4">
        <div className="flex items-center justify-between border-b border-slate-100 pb-3">
          <div>
            <h3 className="text-lg font-semibold text-slate-900">Active Batch Assessments & Quizzes</h3>
            ...
            >
              <div className="space-y-1">
                <div className="flex items-center gap-2">
                  ...
                  {item.highlight && (
                    <span className="px-2 py-0.5 rounded-full bg-amber-400 text-indigo-950 text-[9px] font-semibold">
              ...
              <div className="flex items-center gap-4">
                <div className="text-right">
                  ...
                  <span className={`text-base font-semibold ${item.avgScore < 60 ? 'text-red-600' : 'text-emerald-700'}`}>
                    {item.avgScore}%
                  </span>
                </div>
                ...
                <button
                  ...
                  className={`px-3 py-1.5 rounded-lg text-xs font-bold transition-colors ${
                    item.highlight
                      ...
                      : 'bg-white border border-slate-300 text-indigo-700 hover:bg-indigo-50 hover:border-indigo-300'
                  }`}
                >
