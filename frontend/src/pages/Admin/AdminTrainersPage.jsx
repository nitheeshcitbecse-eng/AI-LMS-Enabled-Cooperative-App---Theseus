    ...
    <div className="space-y-6 pb-16">
      ...
      <div className="ncct-page-header space-y-4">
        <div>
          <div className="flex items-center gap-2">
            <h1 className="text-xl font-semibold text-slate-900">Trainer Faculty Capacity & Load Balancing</h1>
      ...
      <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-2xs space-y-4">
        <div className="flex items-center justify-between border-b border-slate-100 pb-3">
          <h2 className="text-lg font-semibold text-slate-900">Faculty Utilization & Availability</h2>
            ...
            <tbody className="divide-y divide-slate-100">
              {trainerCapacity.map(trainer => (
                <tr key={trainer.id} className="hover:bg-slate-50 transition-colors">
                  <td className="py-3 px-3">
                    <div className="flex items-center gap-2.5">
                      ...
                      <div>
                        ...
                        <span className="text-[10px] text-slate-400 tabular-nums">{trainer.id}</span>
                      </div>
                    </div>
                  </td>
                  ...
                  <td className="py-3 px-3">
                    <div className="flex items-center gap-2">
                      <span className={`font-semibold ${trainer.utilisation > 90 ? 'text-red-600' : 'text-slate-900'}`}>
                        {trainer.utilisation}%
                      </span>
                  ...
                  <td className="py-3 px-3 text-slate-600 tabular-nums text-[11px]">{trainer.nextAvailable}</td>
