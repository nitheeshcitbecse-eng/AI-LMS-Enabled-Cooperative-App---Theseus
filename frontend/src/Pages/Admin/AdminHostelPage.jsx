...
export const AdminHostelPage = () => {
  const { hostelBlocks, hostelAllocations } = useData();
  return (
    <div className="space-y-6 pb-16">
      ...
      <div className="ncct-page-header space-y-4">
        <div>
          <div className="flex items-center gap-2">
            <h1 className="text-xl font-semibold text-slate-900">Hostel & Accommodation Management</h1>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-2xs space-y-1">
          ...
          <div className="text-2xl font-semibold text-slate-900">240 Beds</div>
        ...
        <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-2xs space-y-1">
          ...
          <div className="text-2xl font-semibold text-indigo-950">221 Beds</div>
        ...
        <div className="bg-white p-5 rounded-2xl border border-emerald-200 shadow-2xs space-y-1">
          ...
          <div className="text-2xl font-semibold text-emerald-800">19 Beds</div>
        ...
        <div className="bg-white p-5 rounded-2xl border border-amber-300 bg-amber-50/20 shadow-2xs space-y-1">
          ...
          <div className="text-2xl font-semibold text-amber-900">3 Alerts</div>
        ...
        {hostelBlocks.map(block => (
          <div key={block.id} className="bg-white p-5 rounded-2xl border border-slate-200 shadow-2xs space-y-3">
            <div className="flex items-center justify-between">
              <h3 className="text-base font-semibold text-slate-900">{block.blockName}</h3>
            ...
            <div className="flex items-center justify-between text-xs tabular-nums pt-1 text-slate-500">
      ...
      <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-2xs space-y-4">
        <div className="flex items-center justify-between border-b border-slate-100 pb-3">
          <h2 className="text-lg font-semibold text-slate-900">Current Residential Trainee Allocations</h2>
            ...
            <tbody className="divide-y divide-slate-100">
              {hostelAllocations.map(item => (
                <tr key={item.id} className="hover:bg-slate-50 transition-colors">
                  ...
                  <td className="py-3 px-3 tabular-nums text-[11px] text-slate-600">
