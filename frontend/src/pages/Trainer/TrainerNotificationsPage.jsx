...
import { Bell, AlertCircle, CheckCircle2, Sparkles } from 'lucide-react';

export const TrainerNotificationsPage = () => {
  const notifications = [
      ...
      <div className="ncct-page-header space-y-4">
        <div>
          <div className="flex items-center gap-2">
            <h1 className="text-xl font-semibold text-slate-900">Trainer Notification Stream</h1>
          ...
          >
            ...
            <div className="flex-1 space-y-1">
              <div className="flex items-center justify-between">
                ...
                <span className="text-[10px] text-slate-400 tabular-nums">{item.time}</span>
              </div>
