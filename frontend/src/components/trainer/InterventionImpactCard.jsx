...
export const InterventionImpactCard = () => {
  ...
  return (
    <div className="ncct-card p-5 space-y-4 bg-gradient-to-br from-white via-white to-emerald-50/20">
      {/* Header */}
      <div className="flex items-center justify-between border-b border-slate-100 pb-3">
        <div>
          <div className="flex items-center gap-2">
            <h3 className="text-lg font-semibold text-slate-900">Closed-Loop Intervention Impact</h3>
      ...
      <div className="p-4 rounded-xl bg-slate-50 border border-slate-200 space-y-4">
        <div className="flex items-center justify-between font-semibold text-xs text-slate-900 border-b border-slate-200 pb-2">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-center">
          ...
          <div className="p-3.5 rounded-xl bg-red-50 border border-red-200 space-y-1">
            <span className="text-[10px] font-semibold text-red-700 uppercase tracking-wider block">1. BEFORE</span>
            <span className="text-2xl font-semibold text-red-950 block">{beforeScore}%</span>
            <span className="text-[10px] text-red-700 font-semibold block">Weak Spot Detected</span>
          </div>

          {/* INTERVENTION */}
          <div className="p-3.5 rounded-xl bg-amber-50 border border-amber-200 space-y-1">
            <span className="text-[10px] font-semibold text-amber-800 uppercase tracking-wider block">2. INTERVENTION</span>
          ...
          <div className="p-3.5 rounded-xl bg-emerald-50 border border-emerald-300 space-y-1 shadow-2xs">
            <span className="text-[10px] font-semibold text-emerald-800 uppercase tracking-wider block">3. AFTER</span>
        ...
        <div className="grid grid-cols-3 gap-2 text-center text-xs pt-1 border-t border-slate-200">
          <div>
            ...
            <span className="font-semibold text-slate-900">6 / 7 Trainees</span>
          </div>
          <div className="border-x border-slate-200">
            <span className="text-[10px] text-slate-500 font-bold block">Verified Improvement</span>
            <span className="font-semibold text-emerald-700">5 / 7 Reached 70%+</span>
          </div>
          <div>
            <span className="text-[10px] text-slate-500 font-bold block">Needs Further Support</span>
            <span className="font-semibold text-amber-700">2 Trainees</span>
          </div>
        </div>
      </div>
    </div>
