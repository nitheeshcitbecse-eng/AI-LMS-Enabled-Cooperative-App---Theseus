...
export const CreateInterventionWizardModal = () => {
  ...
  const [selectedTraineeIds, setSelectedTraineeIds] = useState(['tr-004281', 'tr-004282', 'tr-004283']);
  ...
  const handleFinishAssignment = () => {
    const selectedNames = traineeRiskList
      ...
      <div className="bg-white rounded-2xl max-w-2xl w-full p-6 shadow-2xl ring-1 ring-slate-200 animate-in zoom-in-95 duration-300 space-y-5 relative max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-center gap-3 border-b border-slate-100 pb-3">
          ...
          <div>
            <div className="flex items-center gap-2">
              <h3 className="text-lg font-semibold text-slate-900">Intervention Creation Wizard</h3>
        ...
        {!isAssigned ? (
                      ...
                      >
                        <div className="flex items-center gap-2.5">
                          ...
                          <div>
                            ...
                            <span className="text-[10px] text-slate-500 tabular-nums">Score: {t.assessmentScore}%</span>
                          </div>
                        </div>
            ...
            <div className="pt-3 border-t border-slate-100 flex items-center justify-between">
              {step > 1 ? (
                <button
                  ...
                  className="px-4 py-2 rounded-full bg-white border border-slate-300 hover:bg-indigo-50 hover:border-indigo-300 text-indigo-700 font-bold text-xs flex items-center gap-1 transition-colors"
                >
              ...
              {step < 5 ? (
                <button
                  onClick={() => setStep(step + 1)}
                  className="px-6 py-2.5 rounded-full bg-indigo-600 text-white font-semibold text-xs hover:bg-indigo-700 transition-colors flex items-center gap-1.5 shadow-sm"
                >
                  <span>Next Step</span>
          ...
          <div className="text-center py-6 space-y-5 animate-in zoom-in-95 duration-300">
            ...
            <button
              onClick={handleClose}
              className="px-8 py-3 rounded-full bg-indigo-600 text-white font-semibold text-xs hover:bg-indigo-700 transition-colors shadow-sm"
            >
