      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-slate-100 pb-3">
        <div>
          <div className="flex items-center gap-2">
            <h3 className="text-lg font-semibold text-slate-900">Trainees Needing Attention</h3>
            <span className="px-2.5 py-0.5 rounded-full bg-red-50 text-red-700 text-[10px] font-semibold border border-red-200">
              Risk-Ranked Roster
            </span>
          </div>
            ...
            {filteredList.map(trainee => {
              ...
              return (
                ...
                >
                  <td className="py-3 px-3">
                    <div className="flex items-center gap-2.5">
                      ...
                      <div>
                        ...
                        <span className="text-[10px] text-slate-400 tabular-nums">{trainee.digitalId}</span>
                      </div>
                    </div>
                  </td>
                  ...
                  <td className="py-3 px-3">
                    {displayRisk === 'HIGH' ? (
                      <span className="px-2 py-0.5 rounded-full bg-red-100 text-red-800 text-[10px] font-semibold flex items-center gap-1 w-max border border-red-200">
                        <AlertCircle className="w-3 h-3 text-red-600" /> HIGH RISK
                      </span>
                    ) : displayRisk === 'MEDIUM' ? (
                      <span className="px-2 py-0.5 rounded-full bg-amber-100 text-amber-800 text-[10px] font-semibold flex items-center gap-1 w-max border border-amber-200">
                        <AlertTriangle className="w-3 h-3 text-amber-600" /> MEDIUM RISK
                      </span>
                    ) : (
                      <span className="px-2 py-0.5 rounded-full bg-emerald-100 text-emerald-800 text-[10px] font-semibold flex items-center gap-1 w-max border border-emerald-200">
