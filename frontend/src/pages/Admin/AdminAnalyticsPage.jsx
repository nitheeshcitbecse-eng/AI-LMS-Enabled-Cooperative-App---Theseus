  ...
  return (
    <div className="space-y-6 pb-16">
      ...
      <div className="ncct-page-header space-y-4">
        <div>
          <div className="flex items-center gap-2">
            <h1 className="text-xl font-semibold text-slate-900">Learning & Outcome Analytics</h1>
      ...
      <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-2xs space-y-4">
        <h2 className="text-lg font-semibold text-slate-900 border-b border-slate-100 pb-3">Enrolment vs Completion Trend</h2>
        <div className="h-72">
          <ResponsiveContainer width="100%" height="100%">
            <BarChart data={completionData} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
              ...
              <Tooltip />
              <Bar dataKey="enrolled" fill="#075985" radius={[4, 4, 0, 0]} name="Enrolled Trainees" />
              <Bar dataKey="completed" fill="#0ea5e9" radius={[4, 4, 0, 0]} name="Course Completed" />
            </BarChart>
          </ResponsiveContainer>
        </div>
      </div>
