      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-slate-100 pb-3">
        <div>
          <div className="flex items-center gap-2">
            <h3 className="text-lg font-semibold text-slate-900">Batch Skill Gap Map</h3>
        ...
        {skillsData.map(skill => (
          <div key={skill.name} className="space-y-1.5 p-2.5 rounded-lg border border-slate-100 bg-slate-50/50">
            <div className="flex items-center justify-between text-xs">
              ...
              <span className={`font-semibold ${skill.proficiency < 60 ? 'text-red-600' : 'text-emerald-700'}`}>
