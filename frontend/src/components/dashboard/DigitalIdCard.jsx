...
export const DigitalIdCard = () => {
  ...
  return (
    <div className="ncct-card relative overflow-hidden p-5 flex flex-col justify-between">
      ...
      <div>
        ...
        <div className="flex items-center justify-between gap-2 pb-3 mb-3 border-b border-slate-100">
          <div className="flex items-center gap-2">
            <div className="w-7 h-7 rounded-lg bg-indigo-600 text-emerald-400 flex items-center justify-center font-bold text-xs">
              NCCT
            </div>
            <div>
              <h3 className="text-base font-semibold text-slate-900 tracking-tight">NCCT Digital Identity</h3>
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1 space-y-1">
            <h4 className="text-sm font-bold text-slate-900 leading-tight">{trainee.name}</h4>
            <div className="inline-block tabular-nums text-[11px] font-semibold bg-indigo-50 text-indigo-900 px-2 py-0.5 rounded-full border border-indigo-100">
              {trainee.digitalId}
            </div>
            ...
            <div className="text-[11px] text-slate-600 pt-1 space-y-0.5">
              <p className="flex items-center gap-1.5 truncate">
                ...
                <span className="font-medium text-slate-700">{trainee.institute}</span>
              </p>
