      ...
      <div className="ncct-page-header space-y-4">
        <div>
          <div className="flex items-center gap-2">
            <h1 className="text-xl font-semibold text-slate-900">Institution Settings & Rural Edge Gateway</h1>
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-100 pb-4">
          <div>
            <div className="flex items-center gap-2">
              ...
              <h2 className="text-xl font-semibold text-slate-900">Rural Edge Connectivity Gateway</h2>
        ...
        {isOffline && (
          <div className="bg-amber-500/10 border border-amber-500/40 p-4 rounded-xl flex flex-col sm:flex-row sm:items-center justify-between gap-3 text-amber-950">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-base font-semibold text-slate-900">EDGE MODE ACTIVE — Disconnected from Central Cloud</h3>
            ...
            <button
              onClick={syncData}
              disabled={isSyncing}
              className="px-4 py-2 rounded-full bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-semibold transition-colors shrink-0 shadow-2xs flex items-center gap-1.5"
            >
